...
async function runTests () {
  ...
  test.title('User interface', function () {
    ...
    const repoSource = document.getElementById('repoSourceContainer')
    const repoPath = document.getElementById('repoPathContainer')
    const cloneRecursively = document.getElementById('cloneRecursivelyContainer')
